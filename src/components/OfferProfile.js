        ...
        <div className="ml-2">
          ...
          <div className="flex flex-row gap-4">
            ...
            <div className="flex flex-row gap-1 mt-2">
              ...
              <p class="text-lg text-gray-400 self-center">Revenue Type: CPA</p>
            </div>
            <div className="flex flex-row gap-1 mt-2">
              <svg
                class="h-5 w-5 self-center"
              ...
              <p class="text-lg text-gray-400 self-center">Countries: US, UK</p>
            </div>
            <div className="flex flex-row gap-1 mt-2">
              <svg
                class="h-5 w-5 self-center"
            ...
            <div className="flex flex-row gap-1 mt-2">
              ...
              <p class="text-lg text-gray-400 self-center">Expiry: Date</p>
            </div>
          </div>
        </div>
      </div>
