...
const OfferDistribution = () => {
    ...
    <div className=" flex border border-t-0 border-b-gray justify-between px-4 py-5 sm:px-6">
      <div className="text-left text-xl text-gray-800">Distribution</div>
      <div>
        <button
          type="button"
    ...
    <div className="sm:col-span-1">
            <dt className="text-left font-small text-gray-400">Click Cap:</dt>
            <dd className="mt-1 text-left text-gray-600">123</dd>
          </div>
          <div className="sm:col-span-1">
            <dt className="text-left font-small text-gray-400">Conversion Cap:</dt>
            <dd className="mt-1 text-left text-gray-600">123</dd>
          </div>
          <div className="sm:col-span-1">
            <dt className="text-left font-small text-gray-400">Revenue Cap:</dt>
            <dd className="mt-1 text-left text-gray-600">123</dd>
          </div>
          <div className="sm:col-span-1">
            <dt className="text-left font-small text-gray-400">Payout Cap:</dt>
            <dd className="mt-1 text-left text-gray-600">123</dd>
          </div>
          </dl>
    </div>
