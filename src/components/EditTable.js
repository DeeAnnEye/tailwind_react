          ...
          <div class="shadow overflow-hidden mt-2 border-b border-gray-200 sm:rounded-lg">
            ...
            <fieldset class="space-y-5 flex flex-row">
              ...
              <div class="relative flex items-center p-4">
                <div class="flex items-center h-5">
                  <input
                    id="advertiser"
                    aria-describedby="advertiser-description"
                    name="advertiser"
                    type="checkbox"
                    class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded"
                  />
                ...
                <div class="ml-3 text-sm">
                  <label for="advertiser" class="font-medium text-gray-700">
                    Manage Advertiser
                  </label>
                </div>
              </div>
              <div class="relative flex items-center p-4">
                ...
                <div class="ml-3 text-sm">
                  <label for="publisher" class="font-medium text-gray-700">
                    Manage Publisher
                  </label>
                </div>
              </div>
              <div class="relative flex items-center p-4">
                ...
                <div class="ml-3 text-sm">
                  <label for="report" class="font-medium text-gray-700">
                    Manage Reports
                  </label>
                </div>
              </div>
              <div class="relative flex items-center p-4">
                ...
                <div class="ml-3 text-sm">
                  <label for="user" class="font-medium text-gray-700">
                    Manage Users
                  </label>
                </div>
              </div>
            ...
            <fieldset class=" flex flex-row">
              <div class="relative flex items-center p-4">
                ...
                <div class="ml-3 text-sm">
                  <label for="billing" class="font-medium text-gray-700">
                    Manage Billings
                  </label>
                </div>
              </div>
              ...
              <div class="relative flex items-center p-4">
                <div class="flex items-center h-5">
                  <input
                    id="virtual-user"
                    aria-describedby="virtual-user-description"
                    name="virtual-user"
                    type="checkbox"
                    class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded"
                  />
                ...
                <div class="ml-3 text-sm">
                  <label for="virtual-user" class="font-medium text-gray-700">
                    Virtual User
                  </label>
                </div>
              </div>
              <div class="relative flex items-center p-4">
                ...
                <div class="ml-3 text-sm">
                  <label for="export-stats" class="font-medium text-gray-700">
                    Export Stats
                  </label>
                </div>
              </div>
              <div class="relative flex items-center p-4">
                <div class="flex items-center h-5">
                  <input
                    id="dne-mng"
                    aria-describedby="dne-description"
                    name="dne-mng"
                    type="checkbox"
                    class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded"
                  />
                ...
                <div class="ml-3 text-sm">
                  <label for="dne" class="font-medium text-gray-700">
                    DNE Management
                  </label>
                </div>
              </div>
