...
const AdvertiserActivityLog = () => {
    return <div className="bg-white max-w-2xl h-3/5 min-w-1/4 shadow overflow-hidden sm:rounded-lg">
...
export default AdvertiserActivityLog