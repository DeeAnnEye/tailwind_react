      ...
      <div class="flex justify-between h-16">
        <div class="flex px-2 lg:px-2">
          ...
          <div class="hidden lg:ml-6 lg:flex lg:space-x-8">
            ...
            <a href="#" class="border-indigo-500 text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-small">
              Dashboard
            </a>
            <a href="#" class="border-transparent text-gray-500 hover:border-indigo-500 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-small">
              Offers
            </a>
            <a href="#" class="border-transparent text-gray-500 hover:border-indigo-500 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-small">
              Advertisers
        ...
        <div class="hidden lg:ml-4 lg:flex lg:items-center">
          ...
          <div class="ml-4 relative flex-shrink-0">
            ...
            --> */}
            {showDropDown && <div class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
